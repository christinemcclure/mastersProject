...
<p class="caption" id="t2">Table 2: Website statistics sent to Communications & Marketing.</p>        
 <?php include("/includes/stats-table.html"); ?>
	...
	<div class="row">
      ...
      <p class="citation>Betz, Sonya, Robyn Hall, & Tabatha Farney. (2014, October 27). Polishing Up Your Website. Monterey Conference Center presented at the Internet Librarian, Monterey, CA. Retrieved from http://internet-librarian.infotoday.com/2014/Sessions/B101-Web-Trends-to-Watch-in-2015-7849.aspx</p>
      <p class="citation">Boyd, E. B. (2012). Designing Happiness. Fast Company, (164), 100–101.</p>
      <p class="citation">Costello, D. (2014, November 14). UI Content Strategy: Writing Content for Academic Library Users [webinar]. Retrieved December 7, 2014, from http://discovery.ebsco.com/pulse/article/catch-the-replay-of-ui-content-strategy-writing-content-for-academic-librar</p>
      <p class="citation">Gross, M., Latham, D., & Armstrong, B. (2012). Improving Below-Proficient Information Literacy Skills: Designing an Evidence-Based Educational Intervention. College Teaching, 60(3), 104–111. doi:10.1080/87567555.2011.645257</p>
      <p class="citation">Hoeppner, A. (2012). The Ins and Outs of Evaluating Web-Scale Discovery Services. Computers in Libraries, 32(3), 6–40.</p>
      <p class="citation">How a session is defined in Analytics - Analytics Help. (n.d.). Retrieved January 27, 2015, from https://support.google.com/analytics/answer/2731565?hl=en</p>
      <p class="citation">Katsanos, C., Tselios, N., & Avouris, N. (2010). A Survey of Tools Supporting Design and Evaluation of Websites Based on Models of Human Information Interaction. International Journal on Artificial Intelligence Tools, 19(6), 755–781.</p>
      <p class="citation">King, D. L. (2014, October 27). Web Trends to Watch in 2015. Monterey Conference Center presented at the Internet Librarian, Monterey, CA. Retrieved from http://internet-librarian.infotoday.com/2014/Sessions/B101-Web-Trends-to-Watch-in-2015-7849.aspx</p>
      <p class="citation">Kolowich, S. (n.d.). What Students Don't Know. Retrieved January 13, 2015, from https://www.insidehighered.com/news/2011/08/22/erial_study_of_student_research_habits_at_illinois_university_libraries_reveals_alarmingly_poor_information_literacy_and_skills</p>
      <p class="citation">Kruger, J., & Dunning, D. (1999). Unskilled and unaware of it: How difficulties in recognizing one's own incompetence lead to inflated self-assessments. Journal of Personality and Social Psychology, 77(6), 1121–1134. doi:10.1037/0022-3514.77.6.1121</p>
      <p class="citation">Laird, T. F. N., & Kuh, G. D. (2005). Student Experiences with Information Technology and Their Relationship to Other Aspects of Student Engagement. Research in Higher Education, 46(2), 211–233. doi:10.1007/s11162-004-1600-y</p>
      <p class="citation">Melançon, Benjamin. (c c2011.). The definitive guide to Drupal 7. New York : Apress,. Retrieved from http://library.books24x7.com.ezproxy.gl.iit.edu/toc.aspx?bkid=43343</p>
      <p class="citation">Morton-Owens, E. G. (2011). Editorial and Technological Workflow Tools to Promote Website Quality. Information Technology & Libraries, 30(3), 91–98.</p>
      <p class="citation">Mulder, S. (c2007.). The user is always right : a practical guide to creating and using personas for the Web. Berkeley, CA : New Riders,.</p>
      <p class="citation">Nooshinfard, F., & Ziaei, S. (2011). Academic Library Websites as Marketing Tools. Library Philosophy & Practice, 64–68.</p>
      <p class="citation">O'neil, M. (2014, April 21). Confronting the Myth of the "Digital Native." The Chronicle of Higher Education. Retrieved from http://chronicle.com/article/Confronting-the-Myth-of-the/145949/</p>
      <p class="citation">Our Partnership | HathiTrust Digital Library. (n.d.). Retrieved January 25, 2015, from http://www.hathitrust.org/partnership</p>
      <p class="citation">Paul V. Galvin Library - Mission, Vision, and Strategic Plan. (n.d.). Retrieved December 9, 2014, from http://library.iit.edu/mission/</p>
      <p class="citation">Peck, J. (2010). Beyond Functionality: Aesthetic Considerations in Consumer Behavior. Advances in Consumer Research, 37, 102–106.</p>
      <p class="citation">Pressley, L., & Gilbertson, K. (2011). Librarians as Experts: Using the Web to Assert Our Value. Computers in Libraries, 31(4), 19–23.</p>
      <p class="citation">Prioritizing Structure in Web Content Projects. (n.d.). Retrieved February 18, 2015, from http://alistapart.com/blog/post/prioritizing-structure-in-web-content-projects</p>
